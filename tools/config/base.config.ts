...
import { Environments, InjectableDependency } from './base.config.interfaces';
...
/**
 * This class represents the basic configuration of the base.
...
export class BaseConfig {
  ...
  */
   ...
   * @type {string}
   */
  APP_TITLE = 'Welcome to ng2-pug-scss!';
  ...
  /**
   * The directory of the tasks provided by the base.
   */
  BASE_TASKS_DIR = join(process.cwd(), this.TOOLS_DIR, 'tasks', 'base');
