...
/**
 * Renders pug files in `src/client` to the `dist/tmp` directory.
 */
...
/**
 * Copy html files in `src/client` to the `dist/tmp` directory.
 */
...
/**
 * Executes the build process, processing the PUG and SCSS files.
 */
export = () => merge(processComponentStylesheets(), prepareTemplates(), copyHtmlTemplates(), processExternalStylesheets());
